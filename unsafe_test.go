...
func Test_unsafeFIFOCache_Has(t *testing.T) {
	// Test Has
	t.Run("Test_unsafeFIFOCache_Has", func(t *testing.T) {
		cache := NewUnsafe(3, 0, FIFOPriorityFunc)
		defer cache.Close()
		items := []string{"a", "b", "c"}
		for _, i := range items {
...
func Test_unsafeFIFOCache_Get(t *testing.T) {
	// Test Get
	t.Run("Test_unsafeFIFOCache_Get", func(t *testing.T) {
		cache := NewUnsafe(3, 0, FIFOPriorityFunc)
		defer cache.Close()
		items := []string{"a", "b", "c"}
		for _, i := range items {
...
func Test_unsafeFIFOCache_GetLoad(t *testing.T) {
	// Test GetLoad
	t.Run("Test_unsafeFIFOCache_GetLoad", func(t *testing.T) {
		cache := NewUnsafe(3, 0, FIFOPriorityFunc)
		defer cache.Close()
		items := []string{"a", "b", "c"}
		for _, i := range items {
...
func Test_unsafeFIFOCache_GetLoadErr(t *testing.T) {
	// Test GetLoad
	t.Run("Test_unsafeFIFOCache_GetLoad", func(t *testing.T) {
		cache := NewUnsafe(3, 0, FIFOPriorityFunc)
		defer cache.Close()
...
func Test_unsafeFIFOCache_Remove(t *testing.T) {
	// Test Remove
	t.Run("Test_unsafeFIFOCache_Remove", func(t *testing.T) {
		cache := NewUnsafe(3, 0, FIFOPriorityFunc)
		defer cache.Close()
		items := []string{"a", "b", "c"}
		for _, i := range items {
...
func Test_unsafeFIFOCache_Clear(t *testing.T) {
	// Test Remove
	t.Run("Test_unsafeFIFOCache_Clear", func(t *testing.T) {
		cache := NewUnsafe(3, 0, FIFOPriorityFunc)
		defer cache.Close()
		items := []string{"a", "b", "c"}
		for _, i := range items {
...
func Test_unsafeFIFOCache_Close(t *testing.T) {
	// Test Remove
	t.Run("Test_unsafeFIFOCache_Close", func(t *testing.T) {
		cache := NewUnsafe(3, 0, FIFOPriorityFunc)
		items := []string{"a", "b", "c"}
		for _, i := range items {
			if err := cache.Set(i, strings.ToUpper(i)); err != nil {
...
func Test_unsafeLFUCache_Has(t *testing.T) {
	// Test Has
	t.Run("Test_unsafeLFUCache_Has", func(t *testing.T) {
		cache := NewUnsafe(3, 0, LFUPriorityFunc)
		defer cache.Close()
		items := []string{"a", "b", "c"}
		// {"a", "b", "c"}
		for _, i := range items {
...
func Test_unsafeLRUCache_Has(t *testing.T) {
	// Test Has
	t.Run("Test_unsafeLRUCache_Has", func(t *testing.T) {
		cache := NewUnsafe(3, 0, LRUPriorityFunc)
		defer cache.Close()
		items := []string{"a", "b", "c"}
		// {"a", "b", "c"}
		for _, i := range items {
...
func Test_unsafeLRUCache_Expire(t *testing.T) {
	// Test
	t.Run("Test_unsafeLRUCache_Expire", func(t *testing.T) {
		cache := NewUnsafe(100, time.Second, LRUPriorityFunc)
		defer cache.Close()
